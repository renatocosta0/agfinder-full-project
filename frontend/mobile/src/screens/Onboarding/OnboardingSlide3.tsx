  ...
  return (
    ...
    >
      ...
      <Text style={styles.description}>
        Acesse informações atualizadas sobre preços e disponibilidade de combustíveis nos postos próximos a você. Contribua com atualizações e ajude outros usuários a economizarem tempo.
      </Text>
